...
"""Michael Calvin McCoy"""
'calvin.mccoy@protonmail.com'
'1.0.0'
...
if __name__ == '__main__':
    ...
    # Plaintext:  6574 694c
    # Ciphertext: a868 42f2
    # print(list(map(hex,speck32_64([0x6574, 0x694c], [0x1918, 0x1110, 0x0908, 0x0100], 22))))

    s = SpeckCipher(0x1918111009080100, key_size=64, block_size=32)
    print(hex(s.encrypt(0x6574694c)))
